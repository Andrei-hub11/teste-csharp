...
import PasswordIcon from "../../assets/icons/streamline_visible-solid.svg";
import UserIcon from "../../assets/icons/bxs_user.svg";
...
export const fieldsRegister: Field[] = [
  ...
  },
  {
    name: "lastname",
    label: "Sobrenome",
    validation: yup.string().required("O sobrenome é obrigatório"),
    iconSrc: UserIcon,
  },
  {
    name: "email",
